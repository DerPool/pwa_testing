...
<html lang="en">
  ...
  <title>sw-toolbox/sw-toolbox.js at master · GoogleChromeLabs/sw-toolbox</title>
    <meta name="description" content="A collection of service worker tools for offlining runtime requests">
    <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
  <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
  <meta property="fb:app_id" content="1401488693436528">

    
    <meta property="og:image" content="https://avatars2.githubusercontent.com/u/31970254?s=400&amp;v=4" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="GoogleChromeLabs/sw-toolbox" /><meta property="og:url" content="https://github.com/GoogleChromeLabs/sw-toolbox" /><meta property="og:description" content="sw-toolbox - A collection of service worker tools for offlining runtime requests" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MzAyMDEyMzA0OmY2YjRjNTg0MTNhZGE2YzJkZGM2MDFkNTVjNjQyZTMyZTk2N2NhODFiZjdkNmQzZWJiMTlhMzEyODNkOWNjYzQ=--157564e499bf28e5e9475359ea2ac78604569a1a">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="AFFC:49B9:5B9B93F:BB071BB:5B606D29" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="AFFC:49B9:5B9B93F:BB071BB:5B606D29" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="4652380" /><meta name="octolytics-actor-login" content="DerPool" /><meta name="octolytics-actor-hash" content="3dd6a6e3aaaf24e222d87ff00491cb8f5dcb268381b91cca74968b500e0d3310" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />



  <meta class="js-ga-set" name="userId" content="819fdedf47c1ce508800f0fdb7c3468c" %>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="DerPool">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="Njk4M2QwMzc1OWMxYjI3NzY4OWQ2OWRiMjUwYzQzYTM4MTk1YjdhNDZiZGJlYjlmYzg1NTAwOWQ3NDZhYTZjYXx7InJlbW90ZV9hZGRyZXNzIjoiODYuNjIuODEuNTAiLCJyZXF1ZXN0X2lkIjoiQUZGQzo0OUI5OjVCOUI5M0Y6QkIwNzFCQjo1QjYwNkQyOSIsInRpbWVzdGFtcCI6MTUzMzA0NjA2NSwiaG9zdCI6ImdpdGh1Yi5jb20ifQ==">
  ...
  <meta name="html-safe-nonce" content="ebc2ca2709e5a7dbb731b8df124edc09957b60d2">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="34268206" data-scoped-search-url="/GoogleChromeLabs/sw-toolbox/search" data-unscoped-search-url="/search" action="/GoogleChromeLabs/sw-toolbox/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=FeW3Ur7Us+iQLM4AJ4PXL8QL6qlwv8yQZWr90Ln9b41UPsET/5WsBy7qACQEVLyFhvVRE8rebAoTEjlImD8maQ=="
          spellcheck="false"
          autocomplete="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:4652380" href="/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@DerPool" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/4652380?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          <li class="dropdown-header header-nav-current-user css-truncate">
            Signed in as <strong class="css-truncate-target">DerPool</strong>
          </li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="/DerPool" data-ga-click="Header, go to profile, text:your profile">Your profile</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/DerPool?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/DerPool?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a></li>
            <li><a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, your gists, text:your gists">Your gists</a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">Help</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/settings/profile" data-ga-click="Header, go to settings, icon:settings">Settings</a></li>
          <li>
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="q59dQIvCt+ctn25Vf4YfoEddWmxyKAlxLxLW7As3fIAn0Vmtt/o6/r8CL1w6mv674E4E/DaWQQ1B0BbkoGS07Q==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="BkuIyelRZo1eU1NE5hyTTgusaVWkLwYvOmCAiLziuEiKBYwk1WnrlMzOEk2jAHJVrL83xeCRTlNUokCAF7FwJQ==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="2fHqBbBA56k3vEPmAkpdfHut+cTKxapdaAESqJpgRUuYk3NOCdC3+8dEApveeozkYafJ6OjQDpWtC8s2EjC7MA==" />      <input type="hidden" name="repository_id" id="repository_id" value="34268206" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/GoogleChromeLabs/sw-toolbox/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="RjQfpUmphD2U3AZMXTJ+9ywbTXPU/Y2lbZTW6m0IDQlVxdV5t206Grhi/VJ8VGwRJzwmHqMPvnVf3OqEVkPAcA==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/GoogleChromeLabs/sw-toolbox/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="w17Oboegd4S7Dj61FVaGpQidbIncJ+12HpYpVnOoxeGFHM0ZiR9FVAXX58BDExtv4flyXbUYzMmNAcYAk861VQ==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/GoogleChromeLabs/sw-toolbox/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="9dGZChJNYbvHW53W7A7m7PUI5jyFfdml//MfqO5g/nLTYZAFaioCzZpK6+KjM2evPDuEpc4xE+kb3VsZTZHCbg==" />
            <button
                type="submit"
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.32896s from unicorn-664794f569-wf5hl">GitHub</span>, Inc.</li>
